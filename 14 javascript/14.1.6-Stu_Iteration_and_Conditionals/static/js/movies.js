...
for (let i=0; i < movies.length; i++) {
  ...
  if (1930 <= movie.year && movie.year < 1940 ) {
    movies1930s.push(movie);
  } else if (1940 <= movie.year && movie.year < 1950 ) {
    movies1940s.push(movie);
  } else if (1950 <= movie.year && movie.year < 1960 ) {
    movies1950s.push(movie);
  } else if (1960 <= movie.year && movie.year < 1970 ) {
    movies1960s.push(movie);
  } else if (1970 <= movie.year && movie.year < 1980 ) {
    movies1970s.push(movie);
  } else if (1980 <= movie.year && movie.year < 1990 ) {
    movies1980s.push(movie);
  } else if (1990 <= movie.year && movie.year < 2000 ) {
    movies1990s.push(movie);
  } else if (2000 <= movie.year && movie.year < 2010 ) {
    movies2000s.push(movie);
  } else if (2010 <= movie.year && movie.year < 2020 ) {
